...
if(!isset($_SESSION['id_kasie'])) header("location:../../index.php");
    ...
    $tgl_sekarang = $_POST['tgl_sekarang'];
		...
		kedudukan, alamat,pimpinan,nama, bendera, kapasitas, jumlah, bahan, tahun, keterangan, p_faktor, tgl_sekarang) 
					VALUES('$armada','$pelabuhan','$berangkat','$tujuan','$status','$masaberlaku','$namaperusahaan','$kedudukan','$alamat',
					'$pimpinan','$nama','$bendera','$kapasitas','$jumlah','$bahan','$tahun','$keterangan','$p_faktor','$tgl_sekarang')";
		  ...
		  <div class="card shadow mb-4">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <p><input readonly type="text" name="tgl_sekarang" value="<?php $tgl_sekarang = date('Y-m-d'); echo $tgl_sekarang; ?>" /></p>
