...
if(!isset($_SESSION['id_kasie'])) header("location:../../index.php");

	$id = $_SESSION['id_kasie'];
	$data_kasie = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM user_kasie WHERE username='$id'"));
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">KEPALA SEKSI LLAL</div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $data_kasie['nama']; ?></span>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				  ...
				  while($user_data = mysqli_fetch_array($result)) {
					...
					<td align="center"><input type="button" name="edit" value="&#xf044" id="<?php echo $user_data["id_trayek"]; ?>" class="fa fa-edit btn btn-info edit_data" /></td>
					<td><?php
					  if($user_data['keterangan'] != "DISETUJUI"){
						  echo "<a href='approve.php?id_trayek=$user_data[id_trayek]'' class='btn btn-success'><span class='fa fa-check'></a>";

					  }
						echo "<a href='hapus_trayek.php?id_trayek=$user_data[id_trayek]' class='btn btn-danger' onclick='return confirm_delete()'><span class='fa fa-trash'></a>";
					  }?>
					  </td>
					</tr>
					<?php}
...
<div class="modal fade" id="dataModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   ...
   <div id="add_data_Modal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                 <div class="modal-header">
				  <h5 class="modal-title" id="exampleModalLabel">Ubah Data Trayek</h5>
				  <button class="close" type="button" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">×</span>
				  </button>
				</div>  
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
                          <label>KETERANGAN TRAYEK</label>  
                          <input readonly type="text" name="keterangan" id="keterangan" class="form-control" />  
                          <br />                           
                          <label>PELABUHAN ASAL</label>
						  <select name="pelabuhan" id="pelabuhan" class="form-control" >
                                        <option value="">- Pilih Pelabuhan -</option>
                                        <?php
											$sql_pelabuhan = mysqli_query($connect, "SELECT * FROM data_pelabuhan") or die(mysqli_error($connect));
						  ...
						  <select name="namaperusahaan" id="namaperusahaan" class="form-control">
                          ...
                          <input type="text" name="nama" id="nama" class="form-control" value="<?php echo $user_data['nama']; ?>" />  
                          <br />
						  <label>TUJUAN</label>
                          ...
                          <input type="text" name="berangkat" id="berangkat" class="form-control" />  
                          <br />
						  <label>JUMLAH PENUMPANG</label>  
                          <input type="text" name="jumlah" id="jumlah" class="form-control" />  
                          <br />	
						  <label>KAPASITAS</label>  
                          <input readonly type="text" name="kapasitas" id="kapasitas" class="form-control" />  
                          <br />						  
		...
		$(document).on('click', '.edit_data', function(){  
           ...
           $.ajax({  
                ...
                success:function(data){  
                     ...
                     $('#p_faktor').val(data.p_faktor);
					 $('#kapasitas').val(data.kapasitas);
                     $('#id').val(data.id_trayek);  
                     $('#insert').val("Update");  
...
$('#insert_form').on("submit", function(event){  
           ...
           {  
                alert("Nama Pelabuhan harus diisi..");  
           }  
		   ...
		   else if($('#berangkat').val() == '')  
           {  
                alert("Jam Keberangkatan harus diisi ..");  
           }
			else if($('#jumlah').val() == '')  
           {  
                alert("Jumlah Penumpang harus diisi ..");  
           }
			else if($('#p_faktor').val() == '')  
           {  
                alert("Jam Keberangkatan harus diisi ..");  
           }
			else if($('#kapasitas').val() == '')  
           {  
                alert("Jam Keberangkatan harus diisi ..");  
           }		   
           else  
