...
if(isset($_POST['update'])){  
  ...
  // update user data
  $result = mysqli_query($connect, "UPDATE user_anggota SET nama='$nama', pass='$pass' WHERE id_anggota='$id_anggota'");
...
$result = mysqli_query($connect, "SELECT * FROM user_anggota WHERE id_anggota='$id_anggota'");
        ...
        <div class="container-fluid">
		  ...
		  <!-- ISI -->
			<div class="card shadow mb-4">
				<div class="card-body">
					 <form id="update_anggota" action="editanggota.php" method="POST">
						<h1>UBAH DATA ANGGOTA</h1>

							<!-- One "tab" for each step in the form: -->
								<div class="tab">
									<label>ID</label>  
									<input readonly type="text" name="id_anggota" id="id_anggota" class="form-control" value="<?php echo $id_anggota;?>" />  
									<br />  
                  ...
                  <br>
								...
								<a href="anggota.php"><button type="button" class="btn btn-danger tombol"><i class="fa fa-times"></i> Cancel</button></a>								
					  </form> 
                </div>
            </div>
