...
$result = mysqli_query($connect,"SELECT * FROM user_kasie ORDER BY username DESC");
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				  ...
				  while($user_data = mysqli_fetch_array($result)) {
					  ...
					  echo "<td width='30 px'><a href='edit_kasie.php?id_kasie=$user_data[username]'' class='btn btn-primary tombol'><span class='fa fa-edit'></a>";					 
					  }?>                  
                </table>				
                </div>
            </div>
