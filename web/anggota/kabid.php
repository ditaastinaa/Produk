...
$result = mysqli_query($connect,"SELECT * FROM data_kabid ORDER BY id_kabid DESC");
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
					<tr>
                      <th><center>Nama Kepala Bidang</center></th>
				  ...
				  while($user_data = mysqli_fetch_array($result)) {
					  ...
					  echo "<td><a href='editkabid.php?id_kabid=$user_data[id_kabid]'' class='btn btn-primary tombol'><span class='fa fa-edit'></a>";					 
					  }?>                  
                </table>				
                </div>
            </div>
