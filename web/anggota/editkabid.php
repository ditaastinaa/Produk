...
if(!isset($_SESSION['id_anggota'])) header("location:../../index.php");
	...
	$nip = $_POST['nip'];
		...
		// update user data
		$result = mysqli_query($connect, "UPDATE data_kabid SET nama='$nama', nip='$nip' WHERE id_kabid=$id_kabid");
...
$result = mysqli_query($connect, "SELECT * FROM data_kabid WHERE id_kabid=$id_kabid");
 
while($user_data = mysqli_fetch_array($result))
{	
	$id_kabid = $user_data['id_kabid'];
	$nama = $user_data['nama'];
	$nip = $user_data['nip'];
        ...
        <div class="container-fluid">
		  ...
		  <!-- ISI -->
			...
			<div class="card shadow mb-4">
				<div class="card-body">					
					 <form id="update_kabid" name="update_kabid" action="editkabid.php" method="POST">
						<h1>UBAH DATA KABID</h1>

							<!-- One "tab" for each step in the form: -->
								<div class="tab"> 
									  <input readonly type="hidden" name="id_kabid" id="id_kabid" class="form-control" value="<?php echo $id_kabid;?>" />  
									  <br />  
								...
								<a href="kabid.php"><button type="button" class="btn btn-danger tombol"><i class="fa fa-times"></i> Cancel</button></a>								
					</form>					
				</div>
			</div>
        </div>
