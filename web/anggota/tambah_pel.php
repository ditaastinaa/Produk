...
if(!isset($_SESSION['id_anggota'])) header("location:../../index.php");
	...
	if(isset($_POST['btnsave'])) {
		...
		$tambah_data = "INSERT INTO data_pelabuhan(nama_pel, jenis) 
					VALUES('$nama_pel', '$jenis')";
		if(mysqli_query($connect, $tambah_data)){
			...
			header ('Refresh: 0; URL=tambah_pel.php');
		}
	}
...
<head>
  ...
  <title>SISTEM TRAYEK - Tambah Pelabuhan</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <!-- ISI -->
            ...
            <div class="card-body">
					 <form id="regForm" action="tambah_pel.php" method="post">
						<h1>TAMBAH DATA PELABUHAN</h1>

							<!-- One "tab" for each step in the form: -->
								<div class="tab">
								<p>NAMA PELABUHAN</p>
									<p><input placeholder="Nama Pelabuhan" type="text" name="nama_pel" class="form-control" ></p>
								</div>
								<p>JENIS PELABUHAN</p>
									<p><select name="jenis" id="jenis" class="form-control">
                                        <option>- Pilih Jenis Pelabuhan-</option>
										<option>Pelabuhan Internasional</option>
										<option>Pelabuhan Domestik</option>
                                    </select></p>
