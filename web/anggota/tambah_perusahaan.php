...
if(!isset($_SESSION['id_anggota'])) header("location:../../index.php");
	...
	if(isset($_POST['btnsave'])) {
		...
		$tambah_data = "INSERT INTO data_perusahaan(namaperusahaan, kedudukan, alamat, pimpinan) 
					VALUES('$namaperusahaan', '$kedudukan', '$alamat', '$pimpinan')";
		if(mysqli_query($connect, $tambah_data)){
			...
			header ('Refresh: 0; URL=tambah_perusahaan.php');
		}
	}
...
<head>
  ...
  <title>SISTEM TRAYEK - Tambah Perusahaan</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <!-- ISI -->
            ...
            <div class="card-body">
					 <form id="regForm" action="tambah_perusahaan.php" method="post">
						<h1>TAMBAH DATA PERUSAHAAN</h1>

							<!-- One "tab" for each step in the form: -->
								<div class="tab">
									<p>NAMA PERUSAHAAN</p>
										<p><input required placeholder="Nama Perusahaan" type="text" class="form-control" name="namaperusahaan" ></p>
									<p>KEDUDUKAN KANTOR</p>
										<p><select name="kedudukan" class="form-control" id="kedudukan">
                                        <option>- Pilih Kedudukan Kantor -</option>
										<option>KANTOR PUSAT</option>
										<option>KANTOR CABANG</option>
										</select></p>
									<p>ALAMAT PERUSAHAAN</p>
									<p><textarea required placeholder="Alamat Perusahaan" type="text" class="form-control" name="alamat" ></textarea></p>
									<p>NAMA PIMPINAN</p>
									<p><input required placeholder="Nama Pimpinan" type="text" class="form-control" name="pimpinan" ></p>
								</div>
