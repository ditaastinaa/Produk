...
$result = mysqli_query($connect,"SELECT * FROM data_kapal ORDER BY id_kapal DESC");
...
<head>
  ...
  <title>SISTEM TRAYEK - Kapal</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <div class="d-sm-flex align-items-center justify-content-between mb-4">
			...
			<a href="tambah_kapal.php" type="button" class="btn btn-primary tombol"><span class="fa fa-plus-circle"></span> Tambah Data</a>
			</div>
          </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
					<tr>
					  ...
					  <th><center>Bendera Kapal</center></th>
				  ...
				  while($user_data = mysqli_fetch_array($result)) {
					  echo "<tr>";
					  echo "<td>".$user_data['namakapal']."</td>";
					  echo "<td>".$user_data['bendera']."</td>";
					  echo "<td>".$user_data['namaperusahaan']."</td>";
					  echo "<td><a href='editkapal.php?id_kapal=$user_data[id_kapal]'' class='btn btn-primary tombol'><span class='fa fa-edit'></a>";
					  echo "<td><a href='hapus_kapal.php?id_kapal=$user_data[id_kapal]' class='btn btn-danger' onclick='return confirm_delete()'><span class='fa fa-trash'></a>";
					  }?>                  
                </table>				
                </div>
            </div>
