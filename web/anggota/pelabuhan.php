...
$result = mysqli_query($connect,"SELECT * FROM data_pelabuhan ORDER BY id_pelabuhan DESC");
...
<head>
  ...
  <title>SISTEM TRAYEK - Pelabuhan</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <div class="d-sm-flex align-items-center justify-content-between mb-4">
			...
			<a href="tambah_pel.php" type="button" class="btn btn-primary tombol"><span class="fa fa-plus-circle"></span> Tambah Data</a>
			</div>
          </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
					<tr>
                      <th><center>Nama Pelabuhan</center></th>
					  <th><center>Jenis Pelabuhan</center></th>
				  ...
				  while($user_data = mysqli_fetch_array($result)) {
					  echo "<tr>";
					  echo "<td>".$user_data['nama_pel']."</td>";
					  echo "<td>".$user_data['jenis']."</td>";
					  echo "<td><a href='editpelabuhan.php?id_pelabuhan=$user_data[id_pelabuhan]'' class='btn btn-primary tombol'><span class='fa fa-edit'></a>";
					  echo "<td><a href='hapus_pelabuhan.php?id_pelabuhan=$user_data[id_pelabuhan]' class='btn btn-danger' onclick='return confirm_delete()'><span class='fa fa-trash'></a>";
					  }?>                  
                </table>				
                </div>
            </div>
