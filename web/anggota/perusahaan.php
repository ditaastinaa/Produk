...
$result = mysqli_query($connect,"SELECT * FROM data_perusahaan ORDER BY id_perusahaan DESC");
...
<head>
  ...
  <title>SISTEM TRAYEK - Perusahaan</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <div class="d-sm-flex align-items-center justify-content-between mb-4">
			...
			<a href="tambah_perusahaan.php" type="button" class="btn btn-primary tombol"><span class="fa fa-plus-circle"></span> Tambah Data</a>
			</div>
          </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
					<tr>
					  ...
					  <th><center>Kedudukan Perusahaan</center></th>
				  ...
				  while($user_data = mysqli_fetch_array($result)) {
					  echo "<tr>";
					  echo "<td>".$user_data['namaperusahaan']."</td>";
					  echo "<td>".$user_data['alamat']."</td>";
					  echo "<td>".$user_data['kedudukan']."</td>";
					  echo "<td>".$user_data['pimpinan']."</td>";
					  echo "<td><a href='editperusahaan.php?id_perusahaan=$user_data[id_perusahaan]'' class='btn btn-primary'><span class='fa fa-edit'></a>";
					  echo "<td><a href='hapus_perusahaan.php?id_perusahaan=$user_data[id_perusahaan]' class='btn btn-danger' onclick='return confirm_delete()'><span class='fa fa-trash'></a>";
					  }?>                  
                </table>				
                </div>
            </div>
